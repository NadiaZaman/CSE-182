...
int main() {
    ...
    // Initialize a variable to store the sum of the minor diagonal elements.
    int diagonalSum = 0;

    // Calculate the sum of the minor diagonal elements.
    for (int i = 0; i < rows && i < cols; i++) {
        diagonalSum += matrix[i][cols - 1 - i];
    }

    // Display the sum of the minor diagonal elements.
    std::cout << "Sum of the minor diagonal elements: " << diagonalSum << std::endl;
